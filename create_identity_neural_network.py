...
def main():
    ...
    X0 = gs.Variable("X0", dtype=np.float32, shape=input_shape)
    ...
    node_1 = gs.Node(name="Conv-1", op="Conv", inputs=[X0, W0], outputs=[X1],
    ...
    graph = gs.Graph(nodes=[node_1, node_2, node_3], inputs=[X0], outputs=[X3])
